...
- Step 1: Gather links from the SFU Health and Counselling page until the data becomes redundant or there are no more nested links in the CSV file.
...
- Step 5: Merging the answers and questions files into a single CSV file.
